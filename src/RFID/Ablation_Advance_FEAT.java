...
/**
 * 
 * 根据判断条件来执行pre-selection phase的协议。（该方法论文没有采取。）
 * @author Jiangjin
 *
 */
public class Ablation_Advance_FEAT extends ICNPBasic {
...
//	
	...
	public Ablation_Advance_FEAT(){
		ptname = new String("Ablation_Advance_FEAT");
	}
	...
	double execute(){
		...
		System.out.println("********start Ablation_Advance_FEAT new protocol********** ");
		tcollection = 0;  
		...
		System.out.println("****End Ablation_Advance_FEAT new protocol***** tcollection******:"+ tcollection+"total bit:"+ TOTAL_bits);
		return tcollection;
	}
